...
export default forwardRef(function Contact(_props, ref: ContactProps["ref"]) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center md:gap-7 gap-6 mb-[100px]">
        ...
        <motion.div
          className="relative font-extrabold md:text-6xl text-5xl text-center"
        ...
        >
          ...
          <motion.div
            className="absolute text-3xl md:right-[-2rem] md:top-[0rem] md:left-[34rem] left-[16rem] top-12"
            whileInView={{ scale: 1 }}
            initial={{ scale: 0 }}
            transition={{
              duration: 0.4,
        ...
        <div className="text-center text-white leading-tight">
          Got a question or collaboration opportunity,
          <br />
          Or just simply want to say hi?
          <br />
          Go ahead.
        </div>
        <button
