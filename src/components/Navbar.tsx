...
export default function Navbar() {
  ...
  return (
    <>
      {/* Web version logic */}
      <motion.div
        className={`bg-[#042a2b] text-sm font-bold text-center w-full h-16 fixed md:flex justify-between items-center px-[10%] z-10 hidden border-1`}
      ...
      >
        ...
        <div className="flex gap-7 items-center">
          ...
          <div className="hover:text-[#EE4E2E]">
            <a href="#projects-portion">Projects</a>
          </div>
          <div className="hover:text-[#EE4E2E]">
            <a href="#contact-portion">Contact</a>
          </div>
          <a href={Pdf} target="_blank" rel="noopener noreferrer">
            <button className="border-2 px-2 py-1 rounded-md border-[#5EB1BF] hover:drop-shadow-2xl hover:bg-[#5EB1BF] hover:text-[#042a2b]">
              Resume
            </button>
          </a>
        </div>
      ...
      <AnimatePresence>
        <div className="md:hidden w-full">
          ...
          <motion.svg
            className="mt-5 ml-[10%] fixed z-30 md:hidden"
            width="120"
            height="120"
            viewBox="0 0 100 100"
            fill="none"
